...
//require $dir.'/Conf/'.$domain[0].'/'.$domain[1].'/config.inc.php';
//require $dir.'/Conf/'.$domain[0].'/'.$domain[1].'.ucconfig.php';
//if (defined('UC_API')) {
//require ROOT_PATH.'/www/uc_client/client.php';
//}
load('extend');
...
class UcApi{
    ...
    static protected $authPre = 'wowo_';
